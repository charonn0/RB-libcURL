...
Protected Module Errors
	#tag Method, Flags = &h1
		Protected Function Name(CURLCODE As Integer) As String
		  ...
		  "CURLE_URL_MALFORMAT_USER", "CURLE_COULDNT_RESOLVE_PROXY", "CURLE_COULDNT_RESOLVE_HOST", "CURLE_COULDNT_CONNECT", _
		  "CURLE_FTP_WEIRD_SERVER_REPLY", "CURLE_FTP_ACCESS_DENIED", "CURLE_FTP_USER_PASSWORD_INCORRECT", "CURLE_FTP_WEIRD_PASS_REPLY", _
		  "CURLE_FTP_WEIRD_USER_REPLY", "CURLE_FTP_WEIRD_PASV_REPLY", "CURLE_FTP_WEIRD__FORMAT", "CURLE_FTP_CANT_GET_HOST", _
		  ...
		  "CURLE_TOO_MANY_REDIRECTS ", "CURLE_UNKNOWN_TELNET_OPTION", "CURLE_TELNET_OPTION_SYNTAX ", "CURLE_OBSOLETE", "CURLE_SSL_PEER_CERTIFICATE", _
		  ...
		  "CURLE_CONV_REQD", "CURLE_SSL_CACERT_BADFILE", "CURLE_REMOTE_FILE_NOT_FOUND", "CURLE_SSH", "CURLE_SSL_SHUTDOWN_FAILED", "CURL_LAST")
