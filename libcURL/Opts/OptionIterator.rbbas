	...
	#tag ComputedProperty, Flags = &h21
		#tag Getter
			Get
			  ...
			  DNS_SHUFFLE_ADDRESSES:False, DNS_USE_GLOBAL_CACHE:False, DOH_URL:Nil, ECH:Nil, EGDSOCKET:Nil, ERRORBUFFER:Nil, EXPECT_100_TIMEOUT_MS:1000, _
			  ...
			  SSL_SESSIONID_CACHE:True, SSL_SIGNATURE_ALGORITHMS:Nil, SSL_VERIFYHOST:2, SSL_VERIFYPEER:True, SSL_VERIFYSTATUS:False, STDERR:Nil, STREAM_DEPENDS:Nil, _
			  STREAM_DEPENDS_E:Nil, STREAM_WEIGHT:16, SUPPRESS_CONNECT_HEADERS:False, TCP_FASTOPEN:False, TCP_KEEPALIVE:False, TCP_KEEPCNT:9, _
			  TCP_KEEPIDLE:60, TCP_KEEPINTVL:60, TCP_NODELAY:True, TELNETOPTIONS:Nil, TFTP_BLKSIZE:512, TFTP_NO_OPTIONS:False, TIMECONDITION:0, _
			  TIMEOUT:0, TIMEOUT_MS:0, TIMEVALUE:0, TIMEVALUE_LARGE:0, TLS13_CIPHERS:Nil, TLSAUTH_PASSWORD:Nil, TLSAUTH_TYPE:Nil, TLSAUTH_USERNAME:Nil, _
			  TRAILERDATA:Nil, TRAILERFUNCTION:Nil, TRANSFERTEXT:0, TRANSFER_ENCODING:False, UNIX_SOCKET_PATH:0, UNRESTRICTED_AUTH:False, _
			  UPKEEP_INTERVAL_MS:60000, UPLOAD:False, UPLOAD_BUFFERSIZE:65535, UPLOAD_FLAGS:16, URL:Nil, USERAGENT:Nil, USERNAME:Nil, USERPWD:Nil, USE_SSL:0, _
