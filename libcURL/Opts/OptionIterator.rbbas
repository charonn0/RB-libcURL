	...
	#tag ComputedProperty, Flags = &h21
		#tag Getter
			Get
			  ...
			  ALTSVC:Nil, ALTSVC_CTRL:0, APPEND:False, AUTOREFERER:False, AWS_SIGV4:Nil, BUFFERSIZE:2097152, CAINFO:Nil, CAPATH:Nil, CERTINFO:0, _
			  ...
			  MAX_RECV_SPEED_LARGE:0, MAX_SEND_SPEED_LARGE:0, MIMEPOST:Nil, NETRC:0, NETRC_FILE:Nil, NEW_DIRECTORY_PERMS:493, _
			  ...
			  POSTFIELDSIZE_LARGE:-1, POSTQUOTE:Nil, POSTREDIR:0, PREQUOTE:Nil, PRE_PROXY:Nil, PRIVATE_:Nil, PROGRESSDATA:Nil, PROGRESSFUNCTION:Nil, _
			  PROTOCOLS:0, PROXY:Nil, PROXYAUTH:1, PROXYHEADER:Nil, PROXYPASSWORD:Nil, PROXYPORT:0, PROXYTYPE:0, PROXYUSERNAME:Nil, PROXYUSERPWD:Nil, _
			  PROXY_CAINFO:Nil, PROXY_CAPATH:Nil, PROXY_CRLFILE:Nil, PROXY_ISSUERCERT:Nil, PROXY_ISSUERCERT_BLOB:Nil, PROXY_KEYPASSWD:Nil, _
			  PROXY_PINNEDPUBLICKEY:Nil, PROXY_SERVICE_NAME:Nil, PROXY_SSLCERT:Nil, PROXY_SSLCERTTYPE:"PEM", PROXY_SSLCERT_BLOB:Nil, _
			  PROXY_SSLKEY:Nil, PROXY_SSLKEYTYPE:Nil, PROXY_SSLKEY_BLOB:Nil, PROXY_SSLVERSION:0, PROXY_SSL_CIPHER_LIST:Nil, PROXY_SSL_OPTIONS:0, _
			  PROXY_SSL_VERIFYHOST:2, PROXY_SSL_VERIFYPEER:1, PROXY_TLS13_CIPHERS:Nil, PROXY_TLSAUTH_PASSWORD:Nil, PROXY_TLSAUTH_TYPE:Nil, _
			  PROXY_TLSAUTH_USERNAME:Nil, PROXY_TRANSFER_MODE:False, PUT:False, QUOTE:Nil, RANDOM_FILE:Nil, RANGE:Nil, READDATA:Nil, _
			  READFUNCTION:Nil, REDIR_PROTOCOLS:15, REFERER:Nil, REQUEST_TARGET:Nil, RESOLVE:Nil, RESOLVER_START_DATA:Nil, _
			  RESOLVER_START_FUNCTION:Nil, RESUME_FROM:0, RESUME_FROM_LARGE:0, RTSP_CLIENT_CSEQ:0, RTSP_REQUEST:0, RTSP_SERVER_CSEQ:0, _
			  RTSP_SESSION_ID:Nil, RTSP_STREAM_URI:"'*'", RTSP_TRANSPORT:Nil, SASL_AUTHZID:Nil, SASL_IR:False, SEEKDATA:Nil, SEEKFUNCTION:Nil, _
			  SERVICE_NAME:Nil, SHARE:Nil, SOCKOPTDATA:Nil, SOCKOPTFUNCTION:Nil, SOCKS5_AUTH:1, SOCKS5_GSSAPI_NEC:False, SOCKS5_GSSAPI_SERVICE:Nil, _
			  SSH_AUTH_TYPES:0, SSH_COMPRESSION:False, SSH_HOST_PUBLIC_KEY_MD5:Nil, SSH_KEYDATA:Nil, SSH_KEYFUNCTION:Nil, SSH_KNOWNHOSTS:Nil, _
			  SSH_PRIVATE_KEYFILE:Nil, SSH_PUBLIC_KEYFILE:Nil, SSLCERT:Nil, SSLCERTTYPE:"PEM", SSLCERT_BLOB:Nil, SSLENGINE:Nil, _
