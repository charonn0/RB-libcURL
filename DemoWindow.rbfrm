...
#tag Events Features
	#tag Event
		Sub Open()
		  ...
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.AltSvc) Then Me.AddRow("Alt-Svc")
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.AppleSecTrust) Then Me.AddRow("AppleSecTrust")
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.AsynRR) Then Me.AddRow("Async Resource Record DNS (experimental)")
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.AsyncDNS) Then Me.AddRow("Asynchronous DNS")
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.Brotli) Then Me.AddRow("Brotli decompression")
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.DebugSymbols) Then Me.AddRow("Debug capabilities")
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.ECH) Then Me.AddRow("Encrytped Client Hello (ECH)")
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.CharsetConversion) Then Me.AddRow("Encoding conversion")
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.GSASL) Then Me.AddRow("GSASL")
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.GSSAPI) Then Me.AddRow("GSSAPI")
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.LibZ) Then Me.AddRow("gzip/deflate decompression")
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.HSTS) Then Me.AddRow("HSTS")
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.HTTPSProxy) Then Me.AddRow("HTTPSProxy")
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.HTTP2) Then Me.AddRow("HTTP/2")
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.HTTP3) Then Me.AddRow("HTTP/3")
		  ...
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.LargeFiles) Then Me.AddRow("Large files (>2GB)")
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.Auth_SSPI) Then Me.AddRow("Microsoft SSPI")
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.MultiSSL) Then Me.AddRow("MultiSSL")
		  ...
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.PSL) Then Me.AddRow("PSL")
		  ...
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.SSLSEXPORT) Then Me.AddRow("SSLSEXPORT")
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.ThreadSafe) Then Me.AddRow("ThreadSafe")
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.Auth_TLS_SRP) Then Me.AddRow("TLS-SRP")
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.Unicode) Then Me.AddRow("Unicode")
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.UnixSockets) Then Me.AddRow("UnixSockets")
		  If libcURL.IsFeatureAvailable(libcURL.FeatureType.Zstd) Then Me.AddRow("Zstd decompression")
		End Sub
	#tag EndEvent
	#tag Event
		Sub ExpandRow(row As Integer)
